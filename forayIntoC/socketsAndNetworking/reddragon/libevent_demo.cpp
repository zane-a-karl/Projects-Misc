...
/* This would ask event base to use our logging mechanism */
static void logCob (int sev, const char* msg) {
  switch (sev) {
    case _EVENT_LOG_DEBUG: DLOG(INFO) << msg; break;
    case _EVENT_LOG_WARN: DLOG(WARNING) << msg; break;
    case _EVENT_LOG_ERR: DLOG(ERROR) << msg; break;
    case _EVENT_LOG_MSG:
